export const biography_items = [
    ...
    {
        id: 7,
        title: "Taylor Swift VMA Diss and Feud",
    },
    {
        id: 8,
        title: "Fashion",
    ...
    {
        id: 12,
        title: "Collaboration with Paul McCartney, Rihanna and More Public Outbursts",
        text: [
    ...
    {
        id: 14,
        title: "Tour Cancellation and Return to the Spotlight",
        text: [
    ...
    {
        id: 15,
        title: "Topping the Charts with 'Ye'",
        text: [
    ...
    {
        id: 17,
        title: "'Jesus Is King,' 'Jesus Is Born,' 'Emmanuel' and Operas",
        text: [
